...
const steps = [
  {
    ...
    description: 'Claim 1000 gold (MockUSDC) from the village well. Once per day. No gas required.',
  ...
  },
  {
    ...
    description: 'Watch your gold grow as the market moves. Withdraw your earnings anytime.',
